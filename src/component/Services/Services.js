        ...
        <div className='center-services container'>
          <div className='Services-grid '>
            <div className='single-service'>
              ...
              <h1>web design</h1>
              <h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius.</h2>
            </div>
            <div className='single-service'>
              <img src='https://assets.website-files.com/5dcc0b70294b8865063dcae6/5dd53ca4ea80ee007fb725df_icons8-idea%20(3).svg' alt='#' />
              <h1>prototyping</h1>
              <h2>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe, molestiae!</h2>
            </div>
            <div className='single-service'>
