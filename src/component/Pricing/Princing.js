    ...
    <div className='Pricing'>
      <div className='container'>
        <div className='Pricing-top-part'>
          <p className='Pricing-phrase red-paragraph '>Best prices on the market</p>
          <h1 className='Pricing-title title-1'>Our pricing</h1>
          <p className='Pricing-description grey-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora saepe, culpa consectetur accusamus illo soluta dolorem corporis officia laboriosam et voluptatum recusandae fuga neque! Vero, quos!</p>
        </div>
        <div className='Pricing-grid'>
          <div className='price-info'>
            ...
            <p className='price'>
              <span className='red-paragraph'>$</span> 990
            </p>
          ...
          <div className='price-info'>
            ...
            <p className='price'>
              <span className='red-paragraph'>$</span> 1300
            </p>
            <li>Lorem ipsum </li>
            <li>Lorem ipsum dolor sit amet.</li>
          ...
          <div className='price-info'>
            ...
            <p className='price'>
              <span className='red-paragraph'>$</span> 1700
            </p>
            <li>Lorem ipsum dolor sit amet.</li>
            <li>Lorem ipsum dolor sit amet.</li>
            <li>Lorem ipsum dolor sit amet.</li>
